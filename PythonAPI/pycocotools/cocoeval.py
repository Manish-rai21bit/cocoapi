...
class Params:
    ...
    def setDetParamsCustomBox(self):
        ...
        self.recThrs = np.linspace(.0, 1.00, np.round((1.00 - .0) / .01) + 1, endpoint=True)
        self.maxDets = [1, 10, 100]
        self.areaRng = [[0 ** 2, 1e5 ** 2], [0, 100], [100, 400], [400, 900], [900, 1600], [1600, 2500], [2500, 3600], [3600, 4900], [4900, 6400], [6400, 8100],
        ...
        self.areaRngLbl = ["all", "bin_[0, 100]", "bin_[100, 400]", "bin_[400, 900]", "bin_[900, 1600]", "bin_[1600, 2500]", "bin_[2500, 3600]", "bin_[3600, 4900]", "bin_[4900, 6400]", "bin_[6400, 8100]",
